...
/**
 * A classe usuário é responsável...
 */
class Usuario {
  /**
   * O construtor recebe os dados de um usuario
  ...
  /**
   * @throws {InvalidArgumentError} - Esse erro ocorre...
   */
  async adiciona() {
    ...
    const {id} = usuariosDao.buscaPorEmail(this.email);
    this.id = id;
  }
